...
export function getAllCards(): Card[] {
  return [
    ...
    {name: '排长', type: 'figure', level: 2, imageUrl: 'images/card/排长.png'},
    {name: '连长', type: 'figure', level: 3, imageUrl: 'images/card/连长.png'},
    {name: '营长', type: 'figure', level: 4, imageUrl: 'images/card/营长.png'},
    {name: '团长', type: 'figure', level: 5, imageUrl: 'images/card/团长.png'},
    {name: '旅长', type: 'figure', level: 6, imageUrl: 'images/card/旅长.png'},
    {name: '师长', type: 'figure', level: 7, imageUrl: 'images/card/师长.png'},
    {name: '军长', type: 'figure', level: 8, imageUrl: 'images/card/军长.png'},
    {name: '司令', type: 'figure', level: 9, imageUrl: 'images/card/司令.png'},
